...
public class ActionsSendKeysClickConcept {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		doActionsSendKeys(emailId, "test@gmail");
		doActionsClick(loginBtn);

//		Actions act = new Actions(driver);
//		act.sendKeys(driver.findElement(emailId), "test@gmail.com").build().perform();// click on it,then send keys
//		act.sendKeys(driver.findElement(password), "test@123").build().perform();
//		act.sendKeys(driver.findElement(loginBtn)).click().build().perform();
