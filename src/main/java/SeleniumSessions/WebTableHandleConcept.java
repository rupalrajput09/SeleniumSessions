...
//		selectContact("deepti gupta");
	...
	public static void selectMultipleSameContacts(String contactName) {
		List<WebElement> contactsCheck = driver.findElements(By
				.xpath("(//a[text()='" + contactName + "'])/parent::td/preceding-sibling::td/input[@type='checkbox']"));
	...
	public static String getContactCompanyName(String contactName) {
		return driver
				.findElement(By.xpath(
						"//a[text()='" + contactName + "']/parent::td/following-sibling::td/a[@context='company']"))
				.getText();

	}
	
	// create generic methods for phone, homephone, mobile,email
