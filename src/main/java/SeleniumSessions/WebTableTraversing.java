...
public class WebTableTraversing {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("total columns :- " + getColumnCount());
		System.out.println("column values :- " + getColumnValues());
...
// do same thing for 2nd and 3rd column
